...
N 390 380 410 380 {}
N 400 520 420 520 {}
C {devices/ipin.sym} -180 340 0 0 {name=p1 lab=In_ref1}
...
C {devices/ipin.sym} -170 500 0 0 {name=p5 lab=In2}
...
C {devices/ipin.sym} -180 360 0 0 {name=p10 lab=In1}
C {devices/ipin.sym} -170 480 0 0 {name=p11 lab=In_ref2}
...
C {sky130_fd_pr/res_generic_m1.sym} -50 340 3 0 {name=R1
W=5
L=20
model=res_generic_m5
mult=1}
C {sky130_fd_pr/res_generic_m1.sym} -50 360 1 0 {name=R2
W=5
L=20
model=res_generic_m5
mult=1}
C {sky130_fd_pr/res_generic_m1.sym} -120 480 3 0 {name=R3
W=5
L=20
model=res_generic_m5
mult=1}
C {sky130_fd_pr/res_generic_m1.sym} -120 500 1 0 {name=R4
W=5
L=20
model=res_generic_m5
mult=1}
C {devices/noconn.sym} 410 380 2 0 {name=l2}
C {devices/noconn.sym} 420 520 2 0 {name=l3}
C {devices/ipin.sym} -140 110 0 0 {name=p23 lab=Ex_com}
C {devices/ipin.sym} -140 130 0 0 {name=p24 lab=Ex_in1}
C {devices/ipin.sym} -140 150 0 0 {name=p25 lab=Ex_in2}
