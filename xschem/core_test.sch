...
N -130 500 -40 500 {
lab=In2}
C {devices/ipin.sym} -140 340 0 0 {name=p1 lab=In_ref1}
...
C {devices/ipin.sym} -130 500 0 0 {name=p5 lab=In2}
...
C {devices/ipin.sym} -140 360 0 0 {name=p10 lab=In1}
C {devices/ipin.sym} -130 480 0 0 {name=p11 lab=In_ref2}
...
C {sky130_fd_pr/res_generic_m1.sym} -80 340 3 0 {name=R1
W=20
L=5
model=res_generic_m5
mult=1}
C {sky130_fd_pr/res_generic_m1.sym} -80 360 1 0 {name=R2
W=20
L=5
model=res_generic_m5
mult=1}
C {sky130_fd_pr/res_generic_m1.sym} -10 480 3 0 {name=R3
W=20
L=5
model=res_generic_m5
mult=1}
C {sky130_fd_pr/res_generic_m1.sym} -10 500 1 0 {name=R4
W=20
L=5
model=res_generic_m5
mult=1}
C {devices/ipin.sym} -130 110 0 0 {name=p23 lab=Ex_com}
C {devices/ipin.sym} -130 130 0 0 {name=p24 lab=Ex_in1}
C {devices/ipin.sym} -130 150 0 0 {name=p25 lab=Ex_in2}
C {tia/tia_test.sym} 240 380 0 0 {name=x2}
C {tia/tia_test.sym} 250 520 0 0 {name=x3}
