...
noise v(V_outP1, V_outN1) i1 dec 10 10MEG 4G
print all
* wrdata result_noise.csv inoise_total onoise_total
setplot noise3
plot inoise_spectrum
...
noise v(V_outP1, V_outN1) i1 dec 10 100MEG 0.5G
print all
* wrdata result_noise.csv inoise_total onoise_total
setplot noise3
plot inoise_spectrum
...
.include core_test.spice
.include tia_test.spice
...
C {core_test.sym} 1780 -20 0 0 {name=x1}
