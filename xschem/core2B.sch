...
model=res_generic_m5
mult=1}
C {devices/ipin.sym} -110 130 0 0 {name=p23 lab=Ex_com}
C {devices/ipin.sym} -110 150 0 0 {name=p24 lab=Ex_in1}
C {devices/ipin.sym} -110 170 0 0 {name=p25 lab=Ex_in2}
