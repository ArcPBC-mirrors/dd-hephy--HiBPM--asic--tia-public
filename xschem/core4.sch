...
model=res_generic_m5
mult=1}
C {sky130_fd_pr/res_generic_m1.sym} -140 480 3 0 {name=R3
W=10
L=3
model=res_generic_m5
mult=1}
C {sky130_fd_pr/res_generic_m1.sym} -140 500 1 0 {name=R4
W=10
L=3
model=res_generic_m5
mult=1}
C {devices/noconn.sym} 840 150 2 0 {name=l2}
C {outdriver/outdriver_50ohm_lg.sym} 810 370 0 0 {name=x1}
C {outdriver/outdriver_50ohm_lg.sym} 810 510 0 0 {name=x4}
C {devices/ipin.sym} -100 100 0 0 {name=p23 lab=Ex_com}
C {devices/ipin.sym} -100 120 0 0 {name=p24 lab=Ex_in1}
C {devices/ipin.sym} -100 140 0 0 {name=p25 lab=Ex_in2}
