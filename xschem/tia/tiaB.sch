...
N 3290 -720 3560 -720 { lab=Filter_out}
N 3280 -720 3290 -720 { lab=Filter_out}
...
N 2310 -770 2310 -740 { lab=Out_ref}
...
C {devices/opin.sym} 2430 -790 0 0 {name=p3 lab=Out_ref}
...
descr="v(xtia.vm7D)"}
C {sky130_fd_pr/cap_mim_m3_1.sym} 650 -210 2 1 {name=C3 model=cap_mim_m3_1 W=15 L=20 MF=1 spiceprefix=X}
...
spiceprefix=X
mult=6}
C {sky130_fd_pr/cap_mim_m3_1.sym} 1410 -940 2 0 {name=C5 model=cap_mim_m3_1 W=20 L=20 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 2870 -940 2 0 {name=C1 model=cap_mim_m3_1 W=20 L=20 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 3300 -460 2 0 {name=C2 model=cap_mim_m3_1 W=20 L=20 MF=1 spiceprefix=X}
...
descr="v(xtia.vm28D)"}
C {sky130_fd_pr/cap_mim_m3_1.sym} 1090 -240 2 0 {name=C10 model=cap_mim_m3_1 W=15 L=20 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 2530 -240 2 0 {name=C11 model=cap_mim_m3_1 W=15 L=20 MF=1 spiceprefix=X}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 390 -210 2 0 {name=C6 model=cap_mim_m3_1 W=20 L=20 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 430 -210 2 1 {name=C7 model=cap_mim_m3_1 W=20 L=20 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 3460 -430 2 0 {name=C8 model=cap_mim_m3_1 W=20 L=20 MF=1 spiceprefix=X}
C {devices/lab_wire.sym} 170 -370 0 1 {name=l9 sig_type=std_logic lab=VM10G}
C {devices/lab_wire.sym} 1180 -680 0 1 {name=l10 sig_type=std_logic lab=VM17D}
...
C {devices/lab_wire.sym} 2640 -420 0 1 {name=l19 sig_type=std_logic lab=VM9D}
C {devices/ipin.sym} 3040 -720 0 0 {name=p9 lab=Filter_in}
C {devices/opin.sym} 3590 -720 0 0 {name=p10 lab=Filter_out}
