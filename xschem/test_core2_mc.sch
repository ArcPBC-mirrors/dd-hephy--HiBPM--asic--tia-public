...
C {devices/isource.sym} 1260 10 0 0 {name=I1 value="DC 0 AC 1 PULSE 0 10E-6 10n 0.1n 0.1n 5n 10n"
...
dowhile mc_runNo <= mc_runs
	...
	dowhile var_temp <= max_temp
		...
		wrdata 'result_ac_ac_\{$&var_temp\}deg_\{$&mc_runNo\}.csv' v(v_in1) db(v(v_outp1)-v(v_outn1))
...
descr="i(V1)"}
C {devices/lab_wire.sym} 2120 -20 0 1 {name=l12 sig_type=std_logic lab=V_outN1}
C {devices/lab_wire.sym} 2120 -40 0 1 {name=l22 sig_type=std_logic lab=V_outP1}
...
C {devices/lab_wire.sym} 2120 20 0 1 {name=l7 sig_type=std_logic lab=V_outN2}
C {devices/lab_wire.sym} 2120 0 0 1 {name=l8 sig_type=std_logic lab=V_outP2}
...
C {devices/noconn.sym} 2200 -20 2 0 {name=l15}
C {devices/noconn.sym} 2200 -40 2 0 {name=l18}
C {devices/noconn.sym} 2200 20 2 0 {name=l19}
C {devices/noconn.sym} 2200 0 2 0 {name=l20}
C {devices/noconn.sym} 1630 20 0 0 {name=l11}
C {devices/noconn.sym} 1630 -20 0 0 {name=l14}
C {core2.sym} 1780 -20 0 0 {name=x1}
C {devices/gnd.sym} 1540 -80 0 0 {name=l13 lab=GND}
