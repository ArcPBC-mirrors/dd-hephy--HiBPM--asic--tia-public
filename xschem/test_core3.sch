...
C {devices/lab_wire.sym} 2120 -60 0 1 {name=l22 sig_type=std_logic lab=V_outP1}
C {devices/vdd.sym} 1970 -110 0 0 {name=l1 lab=VDD}
C {devices/gnd.sym} 1960 50 0 0 {name=l4 lab=GND}
C {devices/capa.sym} 1380 0 0 0 {name=C1
m=1
value=3p
footprint=1206
...
C {devices/lab_wire.sym} 1480 0 0 1 {name=l10 sig_type=std_logic lab=V_in1}
...
C {devices/noconn.sym} 2200 -60 2 0 {name=l15}
...
C {core3.sym} 1780 -20 0 0 {name=x1}
C {devices/gnd.sym} 1500 -70 0 0 {name=l5 lab=GND}
C {devices/capa.sym} 1380 200 0 0 {name=C2
m=1
value=3p
footprint=1206
device="ceramic capacitor"}
